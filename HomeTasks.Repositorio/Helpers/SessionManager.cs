...
namespace HomeTasks.Repositorio.Helpers
{
    ...
    public sealed class SessionManager
    {
        ...
        /// <summary>
        /// Opens the conversation (if already exsiting, resuses it). Call this from Application_BeginPreRequestHandlerExecute
        /// </summary>
        ...
        /// <summary>
        /// Gets the current <see cref="NHibernate.ISession"/>. Although this is a singleton, this is specific to the thread/ asp session. If you want to handle mulitple sessions, use <see cref="OpenSession"/> directly. If a session it not open, a new open session is created and returned.
        /// </summary>
